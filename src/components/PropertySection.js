  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center mb-2">Based on your location</h2>
        <p className="text-gray-600 text-center mb-8">Some of our picked properties near you location.</p>
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="relative">
            <input
              ...
              className="pl-10 pr-4 py-2 border rounded-lg w-[300px] focus:ring-2 focus:ring-primary"
            />
